...
Tap any bill to see the full breakdown:
...
1. Open any bill from the Bills screen.
2. Tap the **Download** or **Export** button (top right of the bill).
...
4. The file saves to your device automatically.
