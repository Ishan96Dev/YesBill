        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="p-6 flex flex-col gap-4">
              ...
              <Button variant="ghost" onClick={() => router.push("/login")} className="justify-start">Sign In</Button>
              <Button onClick={() => router.push("/signup")} className="w-full bg-primary">Get Started</Button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
