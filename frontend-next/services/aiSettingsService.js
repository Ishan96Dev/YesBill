    ...
    return [
      {
        ...
        key_prefix: 'sk-',
        models: [
          { id: 'gpt-4.1', name: 'GPT-4.1', description: 'Context: 1,000,000', recommended: true },
          { id: 'gpt-4o', name: 'GPT-4o', description: 'Context: 128,000', recommended: false },
          { id: 'gpt-4o-mini', name: 'GPT-4o Mini', description: 'Context: 128,000', recommended: false },
