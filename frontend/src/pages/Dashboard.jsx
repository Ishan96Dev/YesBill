...
export default function Dashboard() {
  ...
  const dismissAIReminder = async (goToSettings = false) => {
    ...
    if (goToSettings) navigate("/settings/ai");
  };
      ...
      <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-5">
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" variant="outline" className="rounded-xl" onClick={() => navigate("/calendar")}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <WithTooltip tip={`Open ${svc.name} service calendar`} side="left">
                        <button
                          onClick={() => navigate(`/services/${svc.id}/calendar`)}
